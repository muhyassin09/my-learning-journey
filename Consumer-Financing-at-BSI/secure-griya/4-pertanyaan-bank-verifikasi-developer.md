...
```mermaid
flowchart LR
    D["🏗️ Developer<br/>membangun rumah"] -->|"PKS kerjasama"| B["🏦 Bank"]
    B -->|"KPR"| P["🏠 Pembeli"]
    P -.->|"rumah menjadi agunan"| B
```
...
```mermaid
flowchart TD
    S(["Mulai verifikasi berkas"]) --> A{"1. Siapa kamu?<br/>terjawab tuntas?"}
...
> [!CAUTION]
> Jangan mengunggah data nasabah, dokumen developer asli, atau dokumen internal bank ke repositori ini, terutama jika repositori bersifat publik. Gunakan contoh fiktif.
